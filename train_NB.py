...
x = load_data('most_seasons_PCA_90_pct_27_components.csv')
#print(x)
y = load_data('data/labels_most_seasons.csv')

x1 = load_data('recent_seasons_PCA_90_pct_27_components.csv')
#print(x)
...
gnb.fit(scaledX_train, y_train1)


y_pred_train = gnb.predict(scaledX_train)
y_pred_test = gnb.predict(scaledX_test)
y_pred_testR = gnb.predict(scaledXR_test)
...
print("NB on Train:", accuracy_train*100)
