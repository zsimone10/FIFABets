...
y_pred = svm.predict(scaledXR_test)
#y_prob = svm.predict_proba(scaledX_test)
accuracy = accuracy_score(y_testRe, y_pred)
...
cnf = confusion_matrix(y_testRe, y_pred)
plot_confusion_matrix(cnf, classes = ["Home", "Draw", "Away"])
print(classification_report(y_testRe, y_pred))
