...
gbc.fit(scaledX_train, y_train1)

#tree.export_graphviz(gbc, out_file='tree.dot', class_names=["Home Win", "Draw", "Away Win"], leaves_parallel = True, )

y_pred_train = gbc.predict(scaledX_train)
y_pred_test = gbc.predict(scaledX_test)
y_pred_testR = gbc.predict(scaledXR_test)
...
print("gbc on Train:", accuracy_train*100)
print("gbc on Test:", accuracy_test*100)
