...
abc.fit(scaledX_train, y_train1)

#tree.export_graphviz(abc, out_file='tree.dot', class_names=["Home Win", "Draw", "Away Win"], leaves_parallel = True, )

y_pred_train = abc.predict(scaledX_train)
y_pred_test = abc.predict(scaledX_test)
y_pred_testR = abc.predict(scaledXR_test)
...
print("abc on Train:", accuracy_train*100)
print("abc on Test:", accuracy_test*100)
print("abc on Recent Test:", accuracy_testR*100)
